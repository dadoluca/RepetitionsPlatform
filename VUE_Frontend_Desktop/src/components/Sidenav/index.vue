    ...
    <div class="sidenav-header">
      ...
      <router-link class="m-0 navbar-brand" to="/">
        <img
          ...
          alt="main_logo"
        />
        <span class="ms-2 font-weight-bold me-2">Tutoring Service</span>
      </router-link>
    </div>
...
import logo from "@/assets/img/logos/studente.png";
import logo2 from "@/assets/img/logos/studente2.png";
